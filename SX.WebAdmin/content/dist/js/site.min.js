...
function getGridViewData(i,t,r){$grid=$(i),$pager=$grid.find(".sx-gv__pager");var e=$grid.data("ajax-url"),a={};$inputs=$grid.find(".sx-gv__filter-row input"),$inputs.each(function(){$input=$(this);var i=$input.val();if(""!=i){var t=$input.attr("name");a[t]=i}});var d={filterModel:a,order:r,page:t};$.ajax({url:e,data:d,method:"post",success:function(i){$grid.parent().html(i)},complete:function(){$grid.parent().find('[data-toggle="tooltip"]').tooltip()}})}!function(i){i.fn.sx_gv=function(){window.innerWidth>0?window.innerWidth:screen.width;this.each(function(){var t=i(this);t.on("click",".sx-gv__pager a",function(){$a=i(this),$grid=$a.closest(".sx-gv");var t=$a.closest("li").hasClass("active");if(!t){var r=$a.data("page");if($order=$grid.find(".sx-gv__sort-arow"),1==$order.length){var e=$order.closest("th").data("field-name"),a=$order.data("sort-direction"),d={FieldName:e,Direction:a};getGridViewData($grid,r,d)}else getGridViewData($grid,r)}}),t.on("keypress",".sx-gv__filter-row input",function(t){if(13==t.which){$input=i(this),$grid=$input.closest(".sx-gv");var r=$grid.find(".sx-gv__pager li.active a").data("page");getGridViewData($grid,r)}}),t.on("click",".sx-gv__clear-btn",function(){$a=i(this),$grid=$a.closest(".sx-gv"),$grid.find(".sx-gv__filter-row input").val(null),getGridViewData($grid,1)}),t.on("click","th",function(){if(!i(this).hasClass("sx-gv_first-column")){$grid=i(this).closest(".sx-gv");var t=$grid.find(".sx-gv__pager li.active a").data("page");$order=i(this).find(".sx-gv__sort-arow");var r=i(this).data("field-name"),e="Asc";if(1==$order.length){var a=$order.data("sort-direction");"Asc"==a&&(e="Desc")}var d={FieldName:r,Direction:e};getGridViewData($grid,t,d)}}),t.on("change",".sx-gv__select-all-chbx",function(){$chbx=i(this),$grid=$chbx.closest(".sx-gv");var t=$chbx.prop("checked");$a=$grid.find(".sx-gv__add-from-chbx-btn"),t?$grid.find('input[type="checkbox"]').prop("checked","checked"):$grid.find('tbody input[type="checkbox"]').removeAttr("checked")})})}}(jQuery);
function getGridLookupData(t,n){$content=$(n),$.ajax({method:"post",url:t,success:function(t){$content.closest(".sx-gvl").attr("data-is-loaded","true"),$content.html(t),$content.next(".sx-gvl__bottom-panel").show(),$content.sx_gv(),$content.find('[data-toggle="tooltip"]').tooltip()}})}!function(t){t.fn.sx_gvl=function(){window.innerWidth>0?window.innerWidth:screen.width;this.each(function(){var n=t(this);n.on("click",'.input-group > input[type="text"]',function(n){$grid=t(this).closest(".sx-gvl");var o=$grid.attr("data-is-loaded");if("true"==o)return!1;$content=$grid.find(".sx-gvl__content");var i=$grid.data("ajax-url");getGridLookupData(i,$content)}),n.on("click",".input-group-btn button",function(){t(this).parent("span").prev('input[type="text"]').trigger("click")})})}}(jQuery);